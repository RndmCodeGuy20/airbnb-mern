...
export function HotelList({setHotel, setShowHotelDetails}: { setHotel: any, setShowHotelDetails: any }) {
    ...
    const hotels = [
        {
            id: 1,
            name: 'Skykomish Estate',
            location: 'Skykomish, United States',
            price: 10000,
            rating: 4.5,
            image: 'https://images.unsplash.com/photo-1601918774946-25832a4be0d6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8',
        },
        {
            id: 2,
            name: 'Skykomish Estate',
                ...
                <a key={index} href="#" onClick={() => {
                    ...
                    <div
                        ...
                        <div className="p-5">
                            ...
                            <p className="mb-3 font-normal text-dark_gray">{value.location}</p>
                            <div className="flex flex-row justify-between">
                                ...
                                <div className={'flex flex-row items-center'}>
                                    ...
                                    <span className={'text-dark_gray ml-1'}>{value.rating}</span>
                                </div>
                            </div>
                        </div>
                    </div>
